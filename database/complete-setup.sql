-- =====================================================
-- Agriculture Equipment Rental System - Complete Database Setup
-- =====================================================
-- This script creates the entire database from scratch
-- Run this file to set up the complete database in one go
...
CREATE TABLE bookings (
    ...
    INDEX idx_bookings_vendor_status (vendor_id, status),
...
CREATE TABLE feedback (
    ...
    INDEX idx_feedback_vendor_rating (vendor_id, rating),
...
('System Admin', 'admin@agriculture-rental.com', '$2b$10$rQl2WzKz1e/JQqKTQGgMaO1qJ5M6zYv4a3sK8eB9xC7h2Lk5mN3oP');
...
-- Note: No sample vendors, customers, or equipment are added
-- You can add these through the application's registration and admin panel
...
SELECT 'Admin account created: admin@agriculture-rental.com / admin123' as AdminCredentials;
SELECT 'You can now register vendors and customers through the application' as Note;
